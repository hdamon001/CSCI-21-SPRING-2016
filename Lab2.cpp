                ...
                int &pennies)
{
  ...
  int after_quarter=initial_value%25;
  dimes=after_quarter/10;
  int after_dime=after_quarter%10;
  nickels=after_dime/5;
  int after_nickel=after_dime%5;
  pennies=after_nickel/1;
}
...
int main()
{
  ...
  cout<<"Launch distance: "<<endl
      <<LaunchHumanCannonball(42.67,45.0);
